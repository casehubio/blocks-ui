...
export default defineConfig({
  resolve: {
    alias: [
      ...
      ...(existsSync(path.resolve(__dirname, '../../.casehub-packages/packages/graph-core/src')) ? [{ find: '@casehubio/graph-core', replacement: path.resolve(__dirname, '../../.casehub-packages/packages/graph-core/src') }] : []),
      ...(existsSync(path.resolve(__dirname, '../../.casehub-packages/packages/graph-renderer/src')) ? [{ find: '@casehubio/graph-renderer', replacement: path.resolve(__dirname, '../../.casehub-packages/packages/graph-renderer/src') }] : []),
    ],
  },
  esbuild: {
    target: 'es2022',
