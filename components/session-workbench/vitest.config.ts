...
export default defineConfig({
  resolve: {
    alias: [
      ...
      { find: '@casehubio/blocks-ui-session-list', replacement: path.resolve(__dirname, '../session-list/src') },
      { find: '@casehubio/blocks-ui-session-detail', replacement: path.resolve(__dirname, '../session-detail/src') },
