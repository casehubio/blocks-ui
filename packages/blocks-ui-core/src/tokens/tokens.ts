...
export const DENSITY_COMPACT_OVERRIDES: Record<string, string> = {
  ...
  '--blocks-space-5': '16px',
  '--blocks-space-6': '20px',
  '--blocks-font-size-xs': '10px',
  '--blocks-font-size-sm': '11px',
  '--blocks-font-size-base': '13px',
  '--blocks-font-size-lg': '14px',
  '--blocks-font-size-xl': '18px',
  '--blocks-font-size-2xl': '20px',
  '--blocks-line-height-xs': '14px',
  '--blocks-line-height-sm': '14px',
  '--blocks-line-height-base': '18px',
  '--blocks-line-height-lg': '20px',
};
