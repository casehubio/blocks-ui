...
# Pack all publishable @casehubio/blocks-ui-* packages into individual tarballs,
...
# Cross-repo @casehubio/pages-* deps use "*" and are resolved by consumer resolutions.
#
...
echo "=== Packing @casehubio/blocks-ui packages ==="
