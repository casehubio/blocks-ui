...
describe('blocks-notification-preferences', () => {
  let el: NotificationPreferencesEl;

  beforeEach(async () => {
    el = document.createElement('blocks-notification-preferences') as NotificationPreferencesEl;
  ...
  it('renders all three child components', () => {
    const channelPrefs = el.shadowRoot!.querySelector('blocks-channel-preferences');
    const muteList = el.shadowRoot!.querySelector('blocks-mute-list');
    const snoozeControl = el.shadowRoot!.querySelector('blocks-snooze-control');
  ...
  it('passes endpoint to children', () => {
    const channelPrefs = el.shadowRoot!.querySelector('blocks-channel-preferences') as any;
    const muteList = el.shadowRoot!.querySelector('blocks-mute-list') as any;
    const snoozeControl = el.shadowRoot!.querySelector('blocks-snooze-control') as any;
