...
export default defineConfig({
  resolve: {
    alias: [
      ...
      { find: '@casehubio/blocks-ui-blocks-timeline', replacement: path.resolve(__dirname, '../blocks-timeline/src') },
      { find: '@casehubio/blocks-ui-execution-monitor', replacement: path.resolve(__dirname, '../execution-monitor/src') },
