...
@customElement('blocks-example-queue-inbox')
export class QueueInboxPage extends LitElement {
  static override styles = css`
    ...
    blocks-work-item-inbox { display: block; height: calc(100% - 80px); }
  `;
  ...
  override render() {
    return html`
      ...
      <blocks-work-item-inbox endpoint="" .identity=${IDENTITY}></blocks-work-item-inbox>
    `;
  }
}
