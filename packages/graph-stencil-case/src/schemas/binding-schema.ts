export const bindingSchema = {
  ...
  properties: {
    ...
    targetType: {
      'x-group': 'Target',
      'x-order': 11,
      'x-discriminator': '_target',
      oneOf: [
        {
          type: 'object',
          title: 'Capability',
          properties: {
            _target: { type: 'string', const: 'capability' },
            capability: {
              type: 'object',
              properties: {
                name: { type: 'string', 'x-help': 'Capability name reference' },
              },
            },
          },
        },
        {
          ...
          title: 'SubCase',
          properties: {
            _target: { type: 'string', const: 'subCase' },
            subCase: {
              type: 'object',
              properties: {
        ...
        },
        {
          ...
          title: 'HumanTask',
          properties: {
            _target: { type: 'string', const: 'humanTask' },
            humanTask: {
              type: 'object',
              properties: {
                title: { type: 'string' },
